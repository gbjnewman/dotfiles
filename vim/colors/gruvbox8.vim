...
if &background ==# 'dark'
  ...
  hi StatusLine guifg=#00008b guibg=#00008b gui=reverse cterm=reverse
  hi StatusLineNC guifg=#00008b guibg=#00008b gui=reverse cterm=reverse
  ...
  if get(g:, 'gruvbox_transp_bg', 0) && !has('gui_running')
    ...
    hi CursorLineNr guifg=#b57614 guibg=#98971a gui=NONE cterm=NONE
    hi FoldColumn guifg=#928374 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'gruvbox_transp_bg', 0)
      ...
      hi VertSplit ctermfg=214 ctermbg=NONE cterm=NONE
    else
      hi Normal ctermfg=187 ctermbg=235 cterm=NONE
      hi CursorLineNr ctermfg=214 ctermbg=237 cterm=bold
